    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ->class('bg-indigo-500 cursor-pointer text-white px-3 py-2.5 m-2 rounded text-sm')
                ->route('users.edit', ['user' => 'id']),

            Button::make('destroy', 'Delete')
                ->class('bg-red-500 cursor-pointer text-white px-3 py-2 m-2 rounded text-sm')
    ...
    public function header(): array
    {
        return [
            Button::add('bulk-sold-out')
                ->caption(__('Delete'))
                ->class('cursor-pointer block bg-indigo-500 text-white px-3 py-2 m-2 rounded text-sm')
